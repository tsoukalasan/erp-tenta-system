...
import { 
  KASETA_732_BASE_PRICES,
  getPriceFromTable
} from '../../constants/pergolaPricingTables';

function Kaseta732Config({ product, onSave }) {
  ...
  const calculatePrices = () => {
    ...
    const basePrice = getPriceFromTable(KASETA_732_BASE_PRICES, roundedProjection, roundedWidth);
    if (basePrice === 0) {
...
export default Kaseta732Config;
