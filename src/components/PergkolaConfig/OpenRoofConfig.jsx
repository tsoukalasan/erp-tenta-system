...
function OpenRoofConfig({ product, onSave, onNavigate }) {
  ...
  const calculatePrices = () => {
    ...
    const basePrice = getPriceFromTable(OPEN_ROOF_BASE_PRICES, config.projection, config.width);
    if (basePrice === 0) {
    ...
    // Υπολογισμός συνόλων
    const subtotal = basePrice + columnCost;

    // Επιβάρυνση χρώματος (μόνο αν είναι custom color - 10%)
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Στρογγυλοποίηση: {roundUpToNextAvailableWidth(OPEN_ROOF_BASE_PRICES, config.projection, config.width)}cm
                </p>
              </div>
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Στρογγυλοποίηση: {roundUpToNextAvailableProjection(OPEN_ROOF_BASE_PRICES, config.projection)}cm
                </p>
              </div>
