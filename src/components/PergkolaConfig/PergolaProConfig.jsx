...
const PergolaProConfig = ({ product, onSave, onNavigate }) => {
  ...
  const calculatePrices = () => {
    ...
    const roundedWidth = roundUpToNextAvailableWidth(PRO100_BASE_PRICES, config.projection, config.width);
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Στρογγυλοποίηση: {roundUpToNextAvailableWidth(PRO100_BASE_PRICES, config.projection, config.width)}cm
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              Στρογγυλοποίηση: {roundUpToNextAvailableProjection(PRO100_BASE_PRICES, config.projection)}cm
            </p>
          </div>
